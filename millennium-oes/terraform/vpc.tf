# -----------------------------------------------------------------------
# VPC — isolated network for the OES
# All compute stays in private subnets; only ALB is public
# -----------------------------------------------------------------------
...
# NAT Gateway — allows private subnets to reach Alpaca API
